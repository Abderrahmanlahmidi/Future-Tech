  ...
  return (
    <section>
      ...
      <div className='grid grid-cols-8 max-md:grid-cols-1 max-md:space-y-[30px] max-md:px-[16px] max-md:py-[40px] px-[80px] py-[60px] bg-[#141414]  border-b border-t border-[#404040]' >
        <div className='col-span-2 items-start flex space-x-[10px] ' >
            <Image src={avatar} alt="avatar" />
            <div>
              <h3 className='text-[#FFFFFF] text-[18px] font-[600]' >John Techson</h3>
              <p className='text-[16px] text-[#98989A]' >Quantum Computing</p>
            </div>
            
            <div className='w-[150px] h-[50px]'>
              <button className='w-[150px] h-[50px] max-md:block items-center max-md:w-full space-x-[4px] border border-1 border-[#262626] rounded-[8px]' >
        ...
        <div className='col-span-6 flex items-center'> 
          ...
          <div className='w-full space-y-[24px]'>
             <h4 className='text-[18px] text-[#98989A]'>October 15, 2023</h4>
             <div>
               <h3 className='text-[22px] font-[600] text-[#fff]' >The Quantum Leap in Computing</h3>
               <p className='text-[#98989A]' >Explore the revolution in quantum computing, its applications, and its potential impact on various industries.</p>
             </div>
             <div>
